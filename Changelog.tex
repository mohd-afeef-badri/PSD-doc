...
\subsubsection{Changed}\label{changed-3}
...
\subsubsection{Bugs removed}\label{bugs-removed-1}
...
\subsubsection{Added}\label{added-6}
...
\subsubsection{Added}\label{added-7}
...
\subsubsection{Changed}\label{changed-10}
